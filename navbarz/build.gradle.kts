...
kotlin {
    ...
    // used to take was removed. The dump under navbarz/api/ is committed so a change to the public
    ...
    sourceSets {
        ...
        commonMain.dependencies {
            ...
            // Internal only — NavBarz wraps NavigationSuiteScaffoldLayout behind its own API
            // surface.
...
// webpack bundle to load Skiko from. NavBarz's web test tasks are disabled (see the note on the js
